                ...
                <div class="product-images">
                    <div class="main-image mb-3">
                        <img src="{{ $product->featured_image ?: 'https://via.placeholder.com/600x400?text=No+Image' }}"
                            alt="{{ $product->name }}" class="img-fluid rounded shadow-sm" id="mainImage">
                    </div>
                ...
                <div class="product-details">
                    ...
                    <div class="product-price mb-4">
                        @if ($product->sale_price && $product->sale_price < $product->price)
                            <span class="current-price h3 text-danger">Rp
                                {{ number_format((float) $product->sale_price, 0, ',', '.') }}</span>
                            <span class="original-price h5 text-muted text-decoration-line-through ms-2">Rp
                ...
                <ul class="nav nav-tabs" id="productTabs" role="tablist">
                    ...
                    {{-- <li class="nav-item" role="presentation">
                        <button class="nav-link" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews"
                            type="button">Reviews ({{ $product->reviews_count ?? 0 }})</button>
                    </li> --}}
                </ul>
