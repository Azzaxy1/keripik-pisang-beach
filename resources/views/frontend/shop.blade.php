                    ...
                    <div class="card-body">
                        ...
                        @endif --}}
                            ...
                            <div class="mb-3">
                                ...
                                @if ($priceRange)
                                    <small class="text-muted">Range: Rp
                                        {{ number_format((float) $priceRange->min_price, 0, ',', '.') }} - Rp
                                        {{ number_format((float) $priceRange->max_price, 0, ',', '.') }}</small>
                                @endif
                            </div>
                        ...
                        @foreach ($products as $product)
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="card product-card h-100">
                                    ...
                                    @endif
                                    <img src="{{ $product->featured_image }}" class="card-img-top product-image"
                                        alt="{{ $product->name }}">
