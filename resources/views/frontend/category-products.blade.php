        ...
        <div class="col-md-12">
            <div class="d-flex align-items-center mb-3">
                @if($category->image_url)
                    <img src="{{ $category->image_url }}" alt="{{ $category->name }}" class="category-header-image me-3" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px;">
                @endif
                <div>
        ...
        @else
            <div class="col-12">
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Check back later for new arrivals or browse other categories.</p>
